            ...
            <v-menu offset-y>
              ...
              <v-list>
                ...
                >
                  ...
                  <v-icon
                    v-if="network.network !== 'telegram'">
                    {{ `mdi-${network.icon}` }}
                  </v-icon>
                  <i class="v-icon notranslate theme--light" v-else>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 58 58">
      ...
      <v-card class="recomendation-block ml-md-8 pa-4 d-md-block">
        <div class="d-flex align-center mb-3">
            ...
            <div class="d-flex flex-column">
              <span class="title">{{ authorInfo.firstName + " " + authorInfo.lastName }}</span>
